...
| table_11-5_nsn_direct_to_earth_command_and_telemetry_capabilities_per_f_forward_command.json | Table 11-5: NSN Direct to Earth Command and Telemetry Capabilities per Frequency | specifications | Forward (Command) Communications |
| table_11-5_nsn_direct_to_earth_command_and_telemetry_capabilities_per_f_return_telemetry.json | Table 11-5: NSN Direct to Earth Command and Telemetry Capabilities per Frequency | specifications | Return (Telemetry) Communications |
| table_11-6_dsn_customers_mission_characteristics_frequencies_and_servic.json | Table 11-6: DSN Customers, Mission Characteristics, Frequencies, and Services | reference | — |
| table_11-7_viasat_ground_stations.json | Table 11-7: Viasat Ground Stations | products | — |
| table_11-8_atlas_federated_antenna_network.json | Table 11-8: ATLAS Federated Antenna Network | products | — |
| table_11-9_service_providers_space_relay.json | Table 11-9: Service Providers for Space Relay Networks | products | — |
| table_11-10_ground_system_components.json | Table 11-10: Ground System Components | reference | — |
